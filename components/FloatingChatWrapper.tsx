...
export default function FloatingChatWrapper() {
  ...
  const [msgs, setMsgs] = useState<{ role: 'user' | 'bot'; text: string }[]>([
    { role: 'bot', text: 'Hi! Ask me about parcel shipping, carrier prices, or tracking 📦' },
  ])
          ...
          >
            <div style={{ flexShrink: 0, padding: '12px 16px', borderBottom: `1px solid rgba(${ACCENT_RGB},0.2)`,
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: '#eef' }}>ParcelIQ AI</span>
            ...
            <div style={{ flexShrink: 0, padding: '10px 12px', borderTop: `1px solid rgba(${ACCENT_RGB},0.15)`,
              ...
              <input value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && send()}
                placeholder="Weight, size, destination — I'll find the cheapest carrier"
