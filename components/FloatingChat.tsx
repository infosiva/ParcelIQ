    ...
    <>
      <motion.button
        ...
        style={{ position: 'fixed', bottom: 24, right: 24, width: 52, height: 52, borderRadius: '50%',
          ...
          boxShadow: '0 4px 20px rgba(59,130,246,0.5)', zIndex: 1000, fontSize: 20 }}
      >
        {open ? '✕' : '📦'}
      </motion.button>
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            style={{ position: 'fixed', bottom: 88, right: 24, width: 320, height: 420,
              background: 'rgba(8,15,26,0.97)', border: '1px solid rgba(59,130,246,0.3)',
              borderRadius: 16, display: 'flex', flexDirection: 'column', zIndex: 1000,
              overflow: 'hidden', backdropFilter: 'blur(20px)' }}
          >
            <div style={{ padding: '12px 16px', borderBottom: '1px solid rgba(59,130,246,0.2)', fontSize: 13, fontWeight: 700, color: '#f1f5f9' }}>
              ParcelIQ Assistant
            </div>
            ...
            <div style={{ padding: '10px 12px', borderTop: '1px solid rgba(59,130,246,0.15)', display: 'flex', gap: 8 }}>
              <input value={input} onChange={e => setInput(e.target.value)}
                ...
                style={{ flex: 1, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(59,130,246,0.25)',
